...
headers = {
    ...
    "Referer": f"https://www.sofascore.com/team/football/esperance-tunis/{team_id}",
...
if res.status_code == 200:
    ...
    df_players.to_excel("esperance_top_players.xlsx", index=False)
else:
    print(f"Erreur top joueurs: {res.status_code}")
    print(res.text)
